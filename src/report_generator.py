"""
finnverify - PDF Report Generator
...
def create_logo_drawing(width=150, height=40):
    """Create finnverify logo as a drawing"""
    ...
    # Text
    d.add(String(35, 20, "finnverify", fontSize=18, fillColor=BRAND_DARK, fontName="Helvetica-Bold"))
...
class ScreeningReportGenerator:
    ...
    def _create_footer(self) -> List:
        ...
        footer_text = f"""
        This report was generated by finnverify Compliance Platform.<br/>
        ...
        © {datetime.now().year} finnverify. All rights reserved.
        """
